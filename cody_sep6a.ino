...
//Defining the pins
#define ldr PC0        //Analog pin for LDR
#define temp PC2       //Analog pin for temperature sensor
#define rgb_red PC4     //PWM pin for red LED
#define rgb_green PC5   //PWM pin for green LED
#define rgb_blue PC6    //PWM pin for blue LED
#define motor_1 PD0     //Motor control pin 1
#define motor_2 PD1     //Motor control pin 2
#define buzzer PC1      //Pin for buzzer
#define pir PB6         //Pin for PIR sensor
#define servo_motor PB1       //Pin for servo motor
#define led PD6      //Pin for led (light system)
...
void loop(){
  ...
  int motorSpeed = map(tempValue,0,1023,0,255); //Adjust according to temp sensor range
  analogWrite(motor_1, motorSpeed);
  analogWrite(motor_2, 0); //To rotate in one direction (Fan)
